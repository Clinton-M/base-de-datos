...
-- solo basic poblado base datos de futbol
...
create view vw_test_vista1 WITH encryption
AS
select C_JUGADOR, N_JUGADOR form JUGADOR


alter view vw_test_vista1 as select N_JUGADOR, D_NACIMIENTO from JUGADOR


select * form vw_test_vista1
select * from JUGADOR


-- code pa ver tabla base 
sp_helptext vw_test_vista1


-- clear

-- vista dos de vista uno
create view vw_test_vista2
as
select * form vw_test_vista1

-- borr vista 1
drop view vw_test_vista2



-- vista de vista 

select * from vw_test_vista1 
a inner join  vw_test_vista2 b

on a.N_JUGADOR = b.N_JUGADOR